...
namespace ShivGardenHouse.Controllers
{
    public class CustomerDashboardController : BaseController
    {
        ...
        public ActionResult UpdatePassword(CustomerDashboard obj)
        {
            ...
            try
            {
                obj.Password = ShivGardenHouse.Crypto.Encrypt(obj.Password);
                obj.NewPassword = ShivGardenHouse.Crypto.Encrypt(obj.NewPassword);
        ...
        public ActionResult EditProfile(CustomerDashboard model)
        {
            ...
            try
            {
                ...
                if (dsPlotDetails != null && dsPlotDetails.Tables.Count > 0)
                {
                    ...
                    model.FirstName = dsPlotDetails.Tables[0].Rows[0]["CustomerName"].ToString();
        ...
        public ActionResult Update(HttpPostedFileBase postedFile, CustomerDashboard model)
        {
            string FormName = "";
            string Controller = "";
            try
